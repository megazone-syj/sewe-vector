...
class FastText {
  ...
  public:
    ...
    void findNNSent(const Matrix&, const Vector&, int32_t,
                const std::set<std::string>&, int64_t, const std::vector<std::string>&, std::vector<std::pair<real,std::string>>&); 
                
    void nn(int32_t);
    void analogies(int32_t);
    void nnSent(int32_t, std::string );
    void nnSent(std::istream&, int32_t, std::string, std::vector<std::pair<real,std::string>>&);
