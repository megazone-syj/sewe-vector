...
public class WEWrapper extends com.megazone.dx.ai.config.WEWrapper {
    static { Loader.load(); }
 ...
 */
    ...
    @Namespace("WEWrapper") @NoOffset public static class FastTextApi extends Pointer {
        static { Loader.load(); }
        /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
        ...
        public native @ByVal FloatStringPairVector nnSentProb(int arg0, @StdString BytePointer arg1, @StdString BytePointer arg2);
        public native @ByVal FloatStringPairVector nnSentProb(int arg0, @StdString String arg1, @StdString String arg2);
        public native @ByVal FloatStringPairVector nnSentProb(int arg0, @StdString BytePointer arg1, @StdString String arg2);
        public native @ByVal FloatStringPairVector nnSentProb(int arg0, @StdString String arg1, @StdString BytePointer arg2);
...
// Parsed from we_wrapper_javacpp.h
