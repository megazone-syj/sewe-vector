...
public class SEWrapper extends com.megazone.dx.ai.config.SEWrapper {
    static { Loader.load(); }
 ...
 */
    ...
    @Namespace("SEWrapper") @NoOffset public static class FastTextApi extends Pointer {
        static { Loader.load(); }
        /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
        ...
        public native @ByVal FloatStringPairVector nnSent( @StdString BytePointer arg0, @StdString BytePointer arg1, int arg2);
        public native @ByVal FloatStringPairVector nnSent( @StdString String arg0, @StdString String arg1, int arg2);
...
// Parsed from se_wrapper_javacpp.h
